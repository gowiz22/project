		...
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body">
					...
					<form class="my-3" id="searchForm" action="${ctxPath}/product/list">
						...
						<div class="d-inline-block">
							<a href="${ctxPath}/product/list" class="btn btn-outline-info">새로고침</a>
						</div>
...
$(function(){
	...
	function checkModal(result){
		...
		if(operation=='register'){
			$('.modal-body').html(result+'번 상품을 등록하였습니다.');
		} else if(operation=='modify'){
			$('.modal-body').html(result+'번 상품을 수정하였습니다.');
		} else if(operation=='remove') {
			$('.modal-body').html(result+'번 상품을 삭제하였습니다.');
		}
	...
	$('#regBtn').click(function(){
		listForm.attr('action', '${ctxPath}/product/register')
				.submit()
	})
	...
	// 조회 페이지로 이동 
		$('.move').click(function(e){
			e.preventDefault();
			let pnoValue = $(this).attr('href');
			searchCondition();
			listForm.append($('<input/>',{type : 'hidden', name : 'pno', value : pnoValue}))
					.attr('action','${ctxPath}/product/get')
					.submit();
		});
